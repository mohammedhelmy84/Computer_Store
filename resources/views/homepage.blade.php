    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container">
        <div class="row gy-4 justify-content-between">
          ...
          <div class="col-lg-6  d-flex flex-column justify-content-center" data-aos="fade-in" dir="rtl">
            <h1>متجرك لشراء كل أجهزة الكمبيوتر وملحقاته: <span>متجر الكمبيوتر</span></h1>
            <p>تصفح الموقع لتختار ما تريد من ممنتجاتنا</p>
            <div class="d-flex">
              <a href="#about" class="btn-get-started">تصفح الآن</a>
            </div>
          </div>
